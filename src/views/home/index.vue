    ...
    <div class="box-info">
      ...
      <div class="title-info">
        <div class="box-left">
          ...
          <div class="body">
            <div class="stats">
              <div class="item">
                <div class="num color1 text-shadow1">184</div>
            ...
            <div class="stats">
              <div class="item">
                <div class="num color1 text-shadow1">177</div>
        ...
        <div class="box-right">
          <div class="header">
            <div class="title">
              销售统计<span
                style="font-size: 12px; color: #ccc; margin-left: 10px"
                >2022.08.01 ~ 2022.08.10</span
              >
            </div>
          </div>
          <div class="body">
            <div class="stats">
              <div class="item">
                <div class="num color3 text-shadow2">4053</div>
                <div class="text color4">订单量（个）</div>
              </div>
            </div>
            <div class="stats">
              <div class="item">
                <div class="num color3 text-shadow2">2.82</div>
      ...
      <div class="table">
        <div class="table-left">
          <!-- 容器 -->
          <div id="main" style="width: 412px; height: 278px" ref="chart"></div>
        </div>
